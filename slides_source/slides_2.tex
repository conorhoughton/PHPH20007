...
$$
\color{black}{}and if \color{reddish}$h_i>theta$\color{black}{} set \color{reddish}$x_i$\color{black}{} to one, otherwise set it to zero.
\end{frame}
...
\begin{frame}{Patterns seperation}
  Dentate Gyrus fixes this problem!
\end{frame}
